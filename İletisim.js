...
function validateForm(theForm) {
   with(theForm) {
      ...
      return (isNotEmpty(txtName, "Lütfen isminizi giriniz!", elmNameError)
           && isNumeric(txtZipcode, "Lütfen 5 basamklı bir posta kodu girin!", elmZipcodeError)
           && isLengthMinMax(txtZipcode, 5, 5, "Lütfen 5 basamklı bir posta kodu girin!", elmZipcodeError)
           && isNumeric(txtPhone, "Lütfen geçerli bir telefon numarası giriniz!", elmPhoneError)
           && isValidEmail(txtEmail, "Lütfen geçerli bir email giriniz!", elmEmailError)
      );
   }
}
